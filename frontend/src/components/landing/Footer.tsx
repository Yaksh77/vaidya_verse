          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-4">
              ...
              <p className="text-blue-100 mb-6 text-lg leading-relaxed">
                Your online doctor consultations. Quality care, anytime,
                anywhere.
              </p>
              <div className="spce-y-3 mb-6">
                {contactInfo.map((info, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-3 text-blue-100"
                  >
                    <info.icon className="w-4 h-4 text-blue-300" />
                    <span>{info.text}</span>
                  </div>
                ))}
              </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-blue-200 text-sm">
                Get the latest news and updates from our website. Subscribe to
                our newsletter to stay up to date with the latest health news
                and trends.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              <input
                ...
                className="px-4 py-2 rounded-lg bg-blue-800/50 border border-blue-600 text-white placeholder:to-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent min-w-[280px]"
              />
        ...
        <div className="py-6 border-t border-blue-700/50">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-blue-200 text-sm">
              <p>&copy: 2025 Vaidya Verse+. All rights reserved</p>
            </div>
