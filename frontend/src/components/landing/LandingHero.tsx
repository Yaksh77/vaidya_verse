    ...
    <section className="py-20 px-4 bg-linear-to-b from-blue-50 to-white">
      <div className="container mx-auto text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Onlline primary care that's affordable with or without insurance.
          Quality care, anytime, anywhere.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Button className="bg-linear-to-r from-blue-800 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-full px-8 py-3 text-lg">
            Book a video visit
          </Button>
          <Link href={"/login/doctor"}>
            <Button
              variant={"outline"}
              className="w-full border-blue-600   hover:bg-blue-50 text-blue-600 rounded-full px-8 py-3 text-lg"
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 text-sm text-gray-600">
          ...
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span>50,000+ Satisifed Patients</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
