...
function AuthForm({ type, userRole }: AuthFormProps) {
  ...
  const handleGoogleAuth = async () => {
    window.location.href = `${process.env.NEXT_PUBLIC_BASE_URL}/auth/google?type=${userRole}`;
  };
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-blue-900">Vaidy Verse+</h1>
      </div>
      ...
      <Card className="border-0 shadow-xl">
        <CardContent className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {isSignup && (
              <div className="flex items-start space-x-2">
                ...
                >
                  I confirm that i am over 18 years old and agree Vadiya Verse+{" "}
          ...
          <div className="mt-6 text-center">
            <span className="text-gray-600 gap-1">{altTextLink} </span>
            <Link
              href={altLinkPath}
